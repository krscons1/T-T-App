...
class SarvamBatchService:
    ...
    async def batch_transcribe(self, local_file_path: str, language_code: str = "ta-IN", destination_dir: str = "downloads") -> Optional[str]:
        ...
        job_start_response = self.start_job(job_id, language_code)
