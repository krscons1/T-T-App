...
export function AnimatedLogo() {
    ...
    if (typeof window !== "undefined") {
      const initializeAnime = async () => {
        try {
          ...
          const staggerDelay = await anime.stagger(100, { start: 800 })
  ...
  return (
    <div className="flex items-center gap-4 mb-8">
      <div ref={logoRef} className="relative p-4 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 shadow-2xl neon-glow">
      ...
      <div ref={textRef} className="space-y-1">
        <h1 className="text-5xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent neon-text">
          Tamil Translator
        </h1>
